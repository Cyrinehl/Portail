...
namespace DataAccess.Insert
{
    public static class DataChangesetFile
    {
        ...
        public static void InsertData( Changesetfile Changesetfile, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while Inserting in table changesetfile:" + e.Message + "\t" + e.GetType();
            }
        ...
        public static int Exist(int FileID, int ChangesetID, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while selecting from table changesetfile:" + e.Message + "\t" + e.GetType();
                return -1;
            }
