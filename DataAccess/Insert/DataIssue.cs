...
namespace DataAccess.Insert
{
    public static class DataIssue
    {
        ...
        public static void InsertData(Issue Issue, MySqlConnection myConnection)
        {
            ...
            try
            {
                ...
                string query = "INSERT INTO issue (CreationDate, DevelopperId, FileId, Line, RuleKey, ServiceId, Severity ,IssueID, Type, UpdateDate)";
                query += " VALUES (@CreationDate, @DevelopperId, @FileId, @Line, @RuleKey, @ServiceId, @Severity, @IssueID, @Type, @UpdateDate)";
            ...
            {
                string error = "Exception Occre while Inserting in table issue:" + e.Message + "\t" + e.GetType();
            }
        ...
        public static string GetIssueInformation(string IssueID, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while selecting from table issue:" + e.Message + "\t" + e.GetType();
                return "erroooooooooooor";
            }

        }

        public static List<IssueRuleType> GetServiceIssues(int ServiceID, MySqlConnection myConnection)
        {
        ...
        public static int CountRows(MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while getting issue's rows:" + e.Message + "\t" + e.GetType();
                return -1;

            }
        }

        public static void UpdateIssue( IssueRuleType Issue, MySqlConnection myConnection, DateTime UpdateTime)
        {
            ...
            {
                string error = "Exception Occre while updating table issue:" + e.Message + "\t" + e.GetType();
        ...
        public static int ExistIssues( string IssueID, string IssueType, MySqlConnection myConnection)
        {
