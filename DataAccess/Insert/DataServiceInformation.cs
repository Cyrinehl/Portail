...
namespace DataAccess.Insert
{
     static public class DataServiceInformation
    {
        ...
        public static void InsertData(Serviceinformation Serviceinformation,MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while Inserting in table serviceinformation:" + e.Message + "\t" + e.GetType();
            }


        }

        public static int GetServiceInformation(string ServiceName, MySqlConnection myConnection)
        {
            ...
            catch (Exception e)
            {
                ...
                string error = "Exception Occre while selecting from table serviceinformation:" + e.Message + "\t" + e.GetType();
                return -1;
            }
