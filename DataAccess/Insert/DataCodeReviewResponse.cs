...
namespace DataAccess.Insert
{
    public class DataCodeReviewResponse
    {
        ...
        public static void InsertData(Codereviewresponse Codereviewresponse, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while Inserting in table codereviewresponse:" + e.Message + "\t" + e.GetType();
            }
        ...
        public static void UpdateCodeReview(int CodeReviewResponseID, Codereviewresponse Codereviewresponse, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while updating table codereviewresponse:" + e.Message + "\t" + e.GetType();
