...
namespace DataAccess.Insert
{
    class DataUserTeam
    {
        public static void InsertData(IConfigurationRoot configuration, Userteam Userteam, MySqlConnection myConnection)
        {         
            try
            {
            ...
            {
                string error = "Exception Occre while Inserting in table userteam :" + e.Message + "\t" + e.GetType();
            }
