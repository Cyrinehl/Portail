    ...
    public class DataCodeReviewRequest
    {
        ...
        public static void InsertData(Codereviewrequest Codereviewrequest, MySqlConnection myConnection)
        {
            ...
            try
            {
                ...
                myCommand.Parameters.AddWithValue("@CodeReviewContext", Codereviewrequest.CodeReviewContext);
            ...
            {
                string error = "Exception Occre while Inserting in table codereviewrequest:" + e.Message + "\t" + e.GetType();
            }
        ...
        public static int ExistsCodeReview(int CodeReviewRequestID, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while selecting from table codereviewrequest:" + e.Message + "\t" + e.GetType();
                return 0;
            }
        ...
        public static void UpdateCodeReview(int CodeReviewRequestID, Codereviewrequest Codereviewrequest, MySqlConnection myConnection)
        {
            ...
            {
                string error = "Exception Occre while updating table codereviewrequest:" + e.Message + "\t" + e.GetType();
